...
Data on diesel versus electric vehicles were limited by general percentages and licenses rather than a physical count of each vehicle going through Amsterdam. In addition, the license for “passing though” does not clarify what kind of engine. For the best results, a counter at each gate/entrance to Amsterdam should keep track of the quantity of boats and their types. The comparison of gas boat to Ford F150 and electric boats are limited by generalized/averaged values for milage, CO2 emissions, and prices. The best practice would be considering the CO2 used to create each vehicle, and to physically run this comparison while tracking the gas/power usage. The economic feasibility is limited by public access to municipality budget and plan, because without this information, it is impossible to know the monetary extent of the municipality. The number of support vehicles is limited by data of previous events in paralympic history, and it might not necessarily be directly applicable to the size and quality of Amsterdam’s canals. The question regarding only allowing electric boats in the waters only considers the direct environmental effects of CO2 emissions in the air at the given moment. CO2 emissions used to create the electric vehicles and gas leakage/seepage into the water are both not accounted for in this calculation.  
